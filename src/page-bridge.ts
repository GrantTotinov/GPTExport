    ...
    window.fetch =
        async function (
            ...
            if (
                ...
                console.log(
                    "GPTExport bridge: conversation response",
                    response.status
                );
            }
        ...
        event => {
            ...
            void (async () => {
                try {
                    ...
                    console.error(
                        "GPTExport bridge: API request failed",
                        error
                    );
